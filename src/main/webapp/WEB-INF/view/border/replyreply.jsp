<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- /WEB-INF/view/border/replyreply.jsp --%>
				...
				<div id="customer-orders" class="col-md-9">
					<div class="box mt-0 mb-lg-0">
						<div class="table-responsive">
							<form:form modelAttribute="replyboard" action="replyreply.shop"
								enctype="multipart/form-data" name="f">
								<input type="hidden" name="no" value="${param.no}">
								<input type="hidden" name="num" value="${param.num}">
								<input type="hidden" name="tema" value="${param.tema}">
								<input type="hidden" name="grp" value="${param.grp}">
								<input type="hidden" name="grplevel" value="${param.grplevel}">
								<input type="hidden" name="grpstep" value="${param.grpstep}">
