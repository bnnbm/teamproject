	...
	<div id="content">
		<div class="container">
			<div class="row bar">
						...
						<div class="panel-body">
							<ul class="nav nav-pills flex-column text-sm">
								...
								<li class="nav-item"><a
									...
									class="nav-link active"><i class="fa fa-sign-out"></i> 배송조회</a></li>
							</ul>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-9">
					<p class="lead">
						기타 궁금한 점이 있으시다면 <a href="../shop/contact.shop">문의</a>해주시고, 평일 AM
						09 - PM 18 연락 가능합니다.
					</p>
					<br />
					<form name="door_to_door_frm"
						...
						</select> <input type="text" style="width: 201px;" class="input_off"
						...
						<script>
							...
							dtd_companys["CJ GLS"] = new Array(
									12,
									"http://nexs.cjgls.com/web/service02_01.jsp?slipno=",
									"123456789012 (12자리)", "1588-5353",
							...
							dtd_companys["경동택배"] = new Array(
									11,
									"http://www.kdexp.com/sub4_1.asp?stype=1&p_item=",
									"12345678901 (최대11자리)", "031-460-2400",
									"http://www.kdexp.com/");
							dtd_companys["이노지스택배"] = new Array(
									13,
							...
							dtd_companys["일양로지스택배"] = new Array(
									...
									"123456789 (9자리)", "1588-0002",
									"http://www.ilyanglogis.com/");
							dtd_companys["CVSnet 편의점택배"] = new Array(
									10,
									"http://was.cvsnet.co.kr/src/ctod_status.jsp?invoice_no=",
									"1234567890 (10자리)", "1566-1025",
								...
								if (company == "UPS") {
									...
									if (!isNumeric(query)) {
										...
										return false;
											...
											&& query.length != 12) {
										alert(company
												+ "의 운송장 번호는 10자리 또는 12자리의 숫자로 입력해주세요.");
										query_obj.focus();
										return false;
									}
									...
									if (!isNumeric(query)) {
										...
										alert(company + "의 운송장 번호는 "
												+ dtd_companys[company][0]
												+ "자리의 숫자로 입력해 주세요.");
										query_obj.focus();
										return false;
									}
							...
							function checkValidDoor(query) {
								...
								if (company == "UPS") {
									...
									if (query.search(pattern1) == -1
										...
										document.door_to_door_frm.dtd_number_query
												.focus();
										return false;
									}
								} else if (company == "EMS") {
