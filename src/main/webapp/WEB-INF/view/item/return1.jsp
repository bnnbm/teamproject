...
<body>
	<form id="f" method="post" action="return2.shop">
		...
		<table class="table" style="width: 100%">
			...
			<tr>
				<td style="width: 40%; text-align: center;">반품사유:</td>
				<td style="width: 60%;"><textarea name="text"
						style="outline-color: #4fbfa8;" cols="30" rows="14" id= "comment"></textarea> <script>
			...
			<tr>
				<td><input class="btn btn-template-outlined btn-sm"
					...
					value="취소" /></td>
				<td><input class="btn btn-template-outlined btn-sm"
					style="width: 100%; margin: auto;" type="submit" value="반품" /></td>
			</tr>
		</table>
	</form>
